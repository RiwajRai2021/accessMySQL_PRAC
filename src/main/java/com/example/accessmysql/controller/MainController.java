...
public class MainController {
  ...
  public @ResponseBody String addNewUser (@RequestParam String name
    ...
    // @ResponseBody means the returned String is the response, not a view name. It is used 
	  // to convert your object into HTTP response in the form client is expecting like JSON, XML or text. 
